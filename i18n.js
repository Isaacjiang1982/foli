const I18N = {
    'zh-CN': {
        app_title: '<img src="flag.png" alt="Flag" class="h-7 inline-block mr-2">燃灯佛历',
        settings: '设置',
        tab_calendar: '日历',
        tab_chant: '修行',
        tab_search: '搜索',
        ...
        dharma_video: '佛49期开示',
        dharma_video_sub: '历期开示下载',
        dharma_audio: '语音开示',
        dharma_audio_sub: '随身聆听法音',
        dharma_master: '祖师大德',
        dharma_master_sub: '历代高僧行谊',
        dharma_live_download: '佛吉祥日直播',
        dharma_live_download_sub: '吉祥日开示下载',
        live_link1: '地址一',
        live_link2: '地址二',
        dharma_sutras: '佛经阅览',
        ...
        fast_day_shuo: '朔日',
        fast_day_month: '月斋',
        fast_day_guanyin: '观音斋',
        desc_guanyin_fast: '观世音菩萨斋日，宜持斋、念佛、诵《观世音菩萨普门品》或持观音圣号。',
        ...
        info_day: '当日信息',
        weather_today: '今日天气',
        weather_loading: '正在获取当地天气...',
        weather_unavailable: '天气暂不可用',
        weather_location_denied: '未获取定位权限',
        disaster_today: '灾害',
        disaster_loading: '正在获取灾害信息...',
        disaster_none: '暂无灾害报道',
        disaster_unavailable: '灾害信息暂不可用',
        disaster_reports: '灾害报道',
        disaster_war: '战争报道',
        disaster_war_none: '暂无战争报道',
        disaster_major: '重大灾难',
        disaster_major_none: '暂未发现达到重大灾难级别的事件',
        disaster_world: '世界灾害',
        disaster_china: '中国灾害',
        disaster_source: '出处',
        disaster_open: '打开报道',
        disaster_expand: '展开灾害报道',
        disaster_collapse: '收起灾害报道',
        disaster_ru_ua: '俄乌',
        disaster_us_iran: '美伊',
        ...
        settings_version: '版本',
        announcement_loading: '正在获取最新通告...',
        announcement_error: '无法加载公告，请检查网络',
        empty_content: '暂无内容',
        last_7_days: '最近7天',
        alarm_time: '响铃时间',
        save_record: '保存记录',
    ...
    'zh-TW': {
        ...
        dharma_video: '佛49期開示',
        dharma_video_sub: '歷期開示下載',
        dharma_audio: '語音開示',
        dharma_audio_sub: '隨身聆聽法音',
        dharma_master: '祖師大德',
        dharma_master_sub: '歷代高僧行誼',
        dharma_live_download: '佛吉祥日直播',
        dharma_live_download_sub: '吉祥日開示下載',
        live_link1: '地址一',
        live_link2: '地址二',
        dharma_sutras: '佛經閱覽',
        ...
        fast_day_shuo: '朔日',
        fast_day_month: '月齋',
        fast_day_guanyin: '觀音齋',
        desc_guanyin_fast: '觀世音菩薩齋日，宜持齋、念佛、誦《觀世音菩薩普門品》或持觀音聖號。',
        ...
        info_day: '當日訊息',
        weather_today: '今日天氣',
        weather_loading: '正在獲取當地天氣...',
        weather_unavailable: '天氣暫不可用',
        weather_location_denied: '未獲取定位權限',
        disaster_today: '災害',
        disaster_loading: '正在獲取災害資訊...',
        disaster_none: '暫無災害報道',
        disaster_unavailable: '災害資訊暫不可用',
        disaster_reports: '災害報道',
        disaster_war: '戰爭報道',
        disaster_war_none: '暫無戰爭報道',
        disaster_major: '重大災難',
        disaster_major_none: '暫未發現達到重大災難級別的事件',
        disaster_world: '世界災害',
        disaster_china: '中國災害',
        disaster_source: '出處',
        disaster_open: '打開報道',
        disaster_expand: '展開災害報道',
        disaster_collapse: '收起災害報道',
        disaster_ru_ua: '俄烏',
        disaster_us_iran: '美伊',
        ...
        settings_version: '版本',
        announcement_loading: '正在獲取最新通告...',
        announcement_error: '無法載入公告，請檢查網絡',
        empty_content: '暫無內容',
        last_7_days: '最近7天',
        alarm_time: '響鈴時間',
        save_record: '保存記錄',
    ...
    'en': {
        ...
        dharma_video: '49-session Teachings',
        dharma_video_sub: 'Teaching Downloads',
        dharma_audio: 'Audio',
        ...
        dharma_live_download: 'Auspicious Day Live',
        dharma_live_download_sub: 'Auspicious Live Downloads',
        live_link1: 'Link 1',
        live_link2: 'Link 2',
        counter_mode: 'Sutra Count',
        ...
        chant_counter: 'Sutra Count',
        chant_timer: 'Meditation',
        today_homework: 'Daily Practice',
        chant_target: 'Sutra Count',
        chant_count_today: 'Recited Today',
        reader_title: 'Reader',
        ...
        fast_day_guanyin: 'Guanyin Fast',
        desc_guanyin_fast: 'Guanyin Bodhisattva fasting day. Suitable for vegetarian observance, Buddha recitation, and reciting the Universal Gate chapter or Guanyin’s name.',
        ...
        // Buddhist festivals (keys match lunar calendar)
        '彌勒菩薩聖誕': 'Maitreya Bodhisattva Birthday',
        '帝釋天尊聖誕': 'Śakra Devānām Indra Birthday',
        '百丈懷海禪師紀念日': 'Venerable Baizhang Huaihai Memorial',
        '釋迦牟尼佛出家日': 'Buddha Śākyamuni Renunciation Day',
        '慧能大師聖誕': 'Master Huineng Birthday',
        '釋迦牟尼佛涅槃': 'Buddha Śākyamuni Parinirvana',
        '觀世音菩薩聖誕': 'Guanyin Bodhisattva Birthday',
        '普賢菩薩聖誕': 'Samantabhadra Bodhisattva Birthday',
        '準提王菩薩誕': 'Cundī Bodhisattva Birthday',
        '文殊菩薩聖誕': 'Mañjuśrī Bodhisattva Birthday',
        '釋迦牟尼佛寶誕': 'Buddha Śākyamuni Birthday',
        '伽藍菩薩聖誕': 'Sangharama Bodhisattva Birthday',
        '韋馱菩薩聖誕': 'Skanda Bodhisattva Birthday',
        '觀世音菩薩成道日': 'Guanyin Bodhisattva Enlightenment Day',
        '大勢至菩薩聖誕': 'Mahāsthāmaprāpta Bodhisattva Birthday',
        '盂蘭盆節': 'Ullambana Festival',
        '諦深佛再道日': 'Buddha Dishen Return Day',
        '虛雲老和尚誕辰': 'Venerable Xuyun Birthday',
        '地藏王菩薩聖誕': 'Kṣitigarbha Bodhisattva Birthday',
        '鳩摩羅什三藏紀念日': 'Kumārajīva Memorial',
        '燃燈古佛聖誕': 'Dīpaṃkara Buddha Birthday',
        '觀世音菩薩出家日': 'Guanyin Bodhisattva Renunciation Day',
        '藥師佛聖誕': 'Bhaisajyaguru Buddha Birthday',
        '道宣律師紀念日': 'Venerable Daoxuan Memorial',
        '達摩祖師聖誕': 'Bodhidharma Birthday',
        '憨山德清大師紀念日': 'Master Hanshan Deqing Memorial',
        '阿彌陀佛聖誕': 'Amitābha Buddha Birthday',
        '諦深佛聖誕': 'Buddha Dishen Birthday',
        '釋迦牟尼佛成道日': 'Buddha Śākyamuni Enlightenment Day',
        '紫柏真可尊者紀念日': 'Venerable Zibo Zhenke Memorial',
        ...
        weather_loading: 'Loading local weather...',
        weather_unavailable: 'Weather unavailable',
        weather_location_denied: 'Location permission denied',
        disaster_today: 'Disasters',
        disaster_loading: 'Loading disaster updates...',
        disaster_none: 'No disaster reports today',
        disaster_unavailable: 'Disaster updates unavailable',
        disaster_reports: 'Disaster reports',
        disaster_war: 'War reports',
        disaster_war_none: 'No war reports',
        disaster_major: 'Major disasters',
        disaster_major_none: 'No events currently meet the major-disaster threshold',
        disaster_world: 'World disasters',
        disaster_china: 'China disasters',
        disaster_source: 'Source',
        disaster_open: 'Open report',
        disaster_expand: 'Expand disaster reports',
        disaster_collapse: 'Collapse disaster reports',
        disaster_ru_ua: 'Russia-Ukraine',
        disaster_us_iran: 'US-Iran',
        ...
        stats_chant: 'Sutra Recitation (Count)',
        stats_meditation: 'Meditation (Min)',
        stats_month_view: 'Overview',
        settings_version: 'Version',
        announcement_loading: 'Loading announcement...',
        announcement_error: 'Failed to load announcement. Please check your connection.',
